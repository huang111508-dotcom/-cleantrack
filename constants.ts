...
export const TRANSLATIONS = {
  en: {
    ...
    realScan: "Start Camera Scan",
    stopCamera: "Stop Camera",
    scanInstruction: "Tap 'Start Camera Scan' to scan the QR code at the location.",
    ...
    loginTitle: "CleanTrack Login",
    loginAsManager: "Manager Login",
    loginAsCleaner: "Cleaner Login",
    password: "Password",
    enterPassword: "Enter Password",
    selectCleaner: "Select your name",
    login: "Login",
    logout: "Logout",
  ...
  zh: {
    ...
    realScan: "开启摄像头扫码",
    stopCamera: "关闭摄像头",
    scanInstruction: "请点击“开启摄像头扫码”，对准点位二维码进行打卡。",
    ...
    loginTitle: "系统登录",
    loginAsManager: "管理员登录",
    loginAsCleaner: "保洁员登录",
    password: "密码",
    enterPassword: "请输入密码",
    selectCleaner: "请选择您的姓名",
    login: "登录",
    logout: "退出登录",
